...
function ExportPdf() {
    ...
    const [buttonText, setButtonText] = useState('Commenter');
    ...
    const saveComment = (comment) => {
        axios.get(`http://localhost:8080/personnes/addcomment/${cv.id}/${comment}`, {
            ...
            setButtonText('Commentaire soumis !'); // Changer le texte du bouton

            // Restaurer le texte du bouton après 2 secondes
            setTimeout(() => {
                setButtonText('Commenter');
            }, 2000);
        }).catch((error) => {
            console.log('error: ', error)
        })
                                ...
                                <div className="form-row row g-3 align-items-center">
                                    ...
                                    <div className="col-md-2">
                                        <button
                                            ...
                                            style={{ marginTop: '31px',marginRight: '10px' }}
                                        >
                                            {buttonText}
                                        </button>
